...
| 2026-04-26 | M6.3: Visuelt redesign | Klar for review | Alle 12 utviklings-PR-er fra implementasjonsplanen levert: tokens (#27), grid, hero, donut → stablet stolpe, tema()/norsk visning/tabell-fallback, komparativ small multiples, rangering med Norge-stripe + PNG-eksport, scatter med direkte etikettering, globalt landgruppe-filter, CSV-nedlasting i footer, tilgjengelighetslinting (axe-core via puppeteer i CI, #37), oppdatert brukerveiledning. Tittelen byttet til "SFSs Ukraina-støtte overvåker", landsnavn på norsk i visningen. | frontend, devops, qa, prosjektleder | Godkjenning av siste M6.3-PR (Steg 12). |
