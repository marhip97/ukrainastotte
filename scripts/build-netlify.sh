...
sed -i 's|<script src="dashboard.js"></script>|<script>window.DATA_PATH="./data/country_summary.csv";window.META_PATH="./data/metadata.json";window.DISB_PATH="./data/financial_disbursements.csv";window.REL_PATH="./data/country_summary_relative.csv";</script><script src="dashboard.js"></script>|' "$SITE/index.html"
